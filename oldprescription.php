...
<head>
    ...
    <title>Old Patient Prescription</title>
...
include "nav.php";
$_SESSION['p_id'] = $_SESSION['old_patient'];
$_SESSION['pres_id'] = rand(time(), 10000000);
$_SESSION['old_patient_pres'] = $_POST['findpres'];
?>
...
<body>
    <form action="pdf.php" method="POST" id="printableArea">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="form-floating">
                                <?php
                                $sql = "SELECT * from patient WHERE p_number = '$_SESSION[old_patient]'";
        ...
        <div class="container" style="margin-top: -80px;">
            <div class="row">
                <div class="col-4">
                    <div class="card text-center">
                        <div class="card-header text-muted">
                            <h3><strong>Previous Condition</strong></h3>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped">
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM `prescription` WHERE press_number = '$_SESSION[old_patient_pres]' ";
                                    $query_run = mysqli_query($conn, $sql);
                                    ...
                                    <tr>
                                        <td>Symptom</td>
                                        <td><?php echo $patient['p_symptom'] ?></td>
                                    </tr>
                                    <tr>
                                        <td>Weight</td>
                        ...
                        <div class="card-body">
                            <table class="table table-striped">
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM `test` WHERE press_number = '$_SESSION[old_patient_pres]' ";
                                    $query_run = mysqli_query($conn, $sql);
                ...
                <div class="col-6">
                    <div class="card text-center">
                        <div class="card-header text-muted">
                            <h3><strong>Previous Medicine</strong></h3>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped">
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM `pres_medicine` WHERE press_number = '$_SESSION[old_patient_pres]' ";
                                    $query_run = mysqli_query($conn, $sql);
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['med_day'] . " days"; ?></td>
                                    </tr>
                                    <?php
                                        }
                                    }
        ...
        <div class="d-grid gap-2 col-6 mx-auto">
            <input class="btn btn-secondary" type="submit" name="old_submit">
